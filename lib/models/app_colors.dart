 ...
 */
  ...
  static const Color background_2 = Color(0xfffff8c0);
//appbar
  // static const Color appbarBackground = Color(0xff3d4757);
  static const Color appbarBackground = Color(0x3d4757);

//Homescreen
  static const Color drunkguesserSchrift = Color(0xff282f39);
  static const Color homescreen_icons = Color(0xff282f39);
  ...
  static const Color shopButtonHomescreenBackground = Color(0xfffaeb4b);

  static const Color backgroundHomeScreen_1 = Color(0xffffffff);
  static const Color backgroundHomeScreen_2 = Color(0xfffff8c0);

//schrift
  static const Color schriftFarbe_hell = Color(0xff8ac747);
  static const Color schriftFarbe_dunkel = Color(0xffffffff);
//Categories
  static const Color schriftFarbeCards = Color(0xff282f39);
  static const Color appBarText = Color(0xff282f39);
  ...
  //Anleitung
  static const Color dotColor_Active = Color(0xff000000);
